...
async def server_create(
    ...
    pq_enabled: str = Form(""),
    vless_encryption: str = Form(""),
    vless_decryption: str = Form(""),
    reality_mldsa65_seed: str = Form(""),
    reality_mldsa65_verify: str = Form(""),
    reality_spider_x: str = Form("/"),
    ...
    item = VpnServer(
            ...
            pq_enabled=pq_enabled == "on",
            vless_encryption=vless_encryption or None,
            vless_decryption=vless_decryption or None,
            reality_mldsa65_seed=reality_mldsa65_seed or None,
            reality_mldsa65_verify=reality_mldsa65_verify or None,
            reality_spider_x=reality_spider_x or "/",
